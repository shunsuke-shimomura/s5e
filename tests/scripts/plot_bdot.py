#!/usr/bin/env python3
"""
Plot angular velocity and angular momentum from bdot convergence test.
...
def main():
    ...
    plt.suptitle("B-dot Controller: Angular Velocity Convergence (Log Scale)", fontsize=14, y=0.995)
    plt.tight_layout()
    ...
    plt.suptitle("B-dot Controller: Angular Momentum Convergence", fontsize=14, y=0.995)
    plt.tight_layout()
    ...
    plt.suptitle("B-dot Controller: Angular Momentum Convergence (Log Scale)", fontsize=14, y=0.995)
    plt.tight_layout()
